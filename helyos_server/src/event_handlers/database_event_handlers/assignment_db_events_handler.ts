...
async function processAssignmentEvents(channel: string, payload: Assignment): Promise<void> {
    const assignment_status: ASSIGNMENT_STATUS | undefined = payload.status as ASSIGNMENT_STATUS;
                ...
                : defaultFallbackMission;
                    ...
                    if (onAssignmentFailure === ON_ASSIGNMENT_FAILURE_ACTIONS.RELEASE) {
                        ...
                        if (fallbackMission) {
                            ...
                            }, 'info', `fallback mission: ${fallbackMission}`);
                            ...
                            }, 'info', `fallback mission dispatched`);
                        }
                    }
